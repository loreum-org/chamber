---
description: "Phase 4b: Depth Loop Driver -- spawns depth agents, scanners, niche agents, and support agents for Aptos audits"
---

# Phase 4b: Adaptive Depth Loop Driver (Aptos)
...
- `~/.claude/prompts/aptos/phase4b-depth-templates.md` -- depth agent role definitions and methodology
- `~/.claude/prompts/aptos/phase4b-scanner-templates.md` -- scanner agent definitions
...
Each depth agent reads its role definition from `~/.claude/prompts/aptos/phase4b-depth-templates.md` and its full methodology from `~/.claude/agents/depth-{role}.md`.
...
## Depth Methodology
Read: ~/.claude/prompts/aptos/phase4b-depth-templates.md -- follow the {ROLE} section
...
Each scanner reads its checks from `~/.claude/prompts/aptos/phase4b-scanner-templates.md`.

```
You are Blind Spot Scanner {LETTER}: {SCANNER_NAME}.

## Scanner Methodology
Read: ~/.claude/prompts/aptos/phase4b-scanner-templates.md -- follow Scanner {LETTER} section
...
## Methodology
Read: ~/.claude/prompts/aptos/phase4b-scanner-templates.md -- follow the Validation Sweep section
...
No built-in fuzzer available for Aptos Move. Skip invariant fuzz and stateful fuzz campaigns.
Write boundary-value parameterized tests instead (handled by depth agents per phase4b-depth-templates.md).
