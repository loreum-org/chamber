---
description: "Phase 4b: Finding Perturbation Agent (Thorough only) -- structured mutations of depth findings"
---
...
After the agent returns, verify `{SCRATCHPAD}/perturbation_findings.md` exists on disk.

Write your output to {SCRATCHPAD}/perturbation_findings.md and stop.
