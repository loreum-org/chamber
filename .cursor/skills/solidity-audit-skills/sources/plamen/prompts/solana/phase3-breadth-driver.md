---
description: "Phase 3: Breadth Analysis Driver -- spawns parallel breadth agents for Solana audits"
---

# Phase 3: Parallel Breadth Analysis (Solana)
...
1. Read the skill file from `~/.claude/agents/skills/solana/{template-name}/SKILL.md` (folder name is lowercase-hyphenated)
...
for each planned agent:
  ...
  for each SKILL.md assigned:
    wc -l ~/.claude/agents/skills/solana/{skill-name}/SKILL.md
